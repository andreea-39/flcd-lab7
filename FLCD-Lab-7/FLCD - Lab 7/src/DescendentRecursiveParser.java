...
public class DescendentRecursiveParser {
    ...
    public void descendantRecursiveParserAlgorithm(String[] sequence, Grammar grammar) {
        ...
        try {
            ...
            writeConfigurationsToFile("C:/Semestrul 5/FLCD/Laboratory/flcd-lab6/FLCD-Lab-6/FLCD - Lab 6//configurations.txt", configurations);
            ...
            if (configuration.getStateOfParsing().equals(State.ERROR_STATE)) {
                ...
                writeTableToFile("C:/Semestrul 5/FLCD/Laboratory/flcd-lab6/FLCD-Lab-6/FLCD - Lab 6//table.txt", constructTree(finalNonTerminals, grammar));
            }
        } catch(Exception e) {
            writeConfigurationsToFile("C:/Semestrul 5/FLCD/Laboratory/flcd-lab6/FLCD-Lab-6/FLCD - Lab 6//configurations.txt", configurations);
